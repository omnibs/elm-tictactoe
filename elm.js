...
Elm.TicTacToe.VictoryConditions.make = function (_elm) {
   ...
   var isWinningMove = F2(function (list,pos) {
      var _p4 = list;
      if (_p4.ctor === "Nothing") {
            return false;
         } else {
            return A2($List.member,pos,_p4._0);
         }
   });
   var detectState = F2(function (player,board) {
      return A3($List.foldl,
      F2(function (positions,_p5) {
         var _p6 = _p5;
         var _p8 = _p6._0;
         var state = slotsToState(A2(getSlots,board,positions));
         var _p7 = state;
         if (_p7.ctor === "Won") {
               return {ctor: "_Tuple2"
                      ,_0: $TicTacToe$Model.Won(_p7._0)
                      ,_1: $Maybe.Just(positions)};
            } else {
               return {ctor: "_Tuple2"
...
Elm.TicTacToe.make = function (_elm) {
   ...
   var stateDescription = function (model) {
      var _p0 = model.state;
      switch (_p0.ctor)
      {case "GameOn": return A2($Basics._op["++"],
           $Basics.toString(model.turn),
           "\'s turn");
         case "Stalled": return "It\'s a Draw";
   ...
   var toTableCell = F5(function (address,
   model,
   rowIdx,
   colIdx,
   slot) {
